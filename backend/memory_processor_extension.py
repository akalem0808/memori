# Extension methods for MemoryProcessor
# These have been integrated into memory_utils.py MemoryProcessor class
# This file is kept for reference only and is no longer needed
